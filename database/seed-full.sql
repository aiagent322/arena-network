...
('Earl Warren Showgrounds','earl-warren-showgrounds','Santa Barbara','CA','3400 Calle Real, Santa Barbara, CA 93105','https://www.earlwarren.com','fairgrounds',1,3,300,150,3000,TRUE,TRUE),
...
((SELECT id FROM arenas WHERE slug='westworld-scottsdale'),'Arizona Sun Circuit','az-sun-circuit-2026','horse show','western','2026-03-20','2026-03-29','Sun Circuit LLC','https://www.suncircuit.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='westworld-scottsdale'),'Scottsdale Parada del Sol Rodeo','parada-del-sol-2026','rodeo','rodeo','2026-03-06','2026-03-08','Scottsdale Jaycees',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='westworld-scottsdale'),'NRCHA Western Derby','nrcha-western-derby-2026','futurity','reined cow horse','2026-04-15','2026-04-26','NRCHA',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='horseshoe-park'),'Queen Creek Barrel Bash','qc-barrel-bash-2026','rodeo','barrel racing','2026-04-18','2026-04-19','AZ Barrel Racing Assoc',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='rancho-rio'),'Rancho Rio Team Roping','rancho-rio-roping-mar-2026','roping','team roping','2026-03-14','2026-03-15','Rancho Rio Productions',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='rancho-rio'),'Rancho Rio Jackpot Roping','rancho-rio-jackpot-apr-2026','roping','team roping','2026-04-11','2026-04-12','Rancho Rio Productions',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='pima-county-fairgrounds'),'Tucson Rodeo — La Fiesta de los Vaqueros','tucson-rodeo-2026','rodeo','rodeo','2026-02-21','2026-02-28','Tucson Rodeo Committee','https://www.tucsonrodeo.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='arizona-state-fairgrounds'),'Arizona National Livestock Show','az-national-livestock-2026','horse show','multi-discipline','2026-12-28','2027-01-04','AQHA',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='lazy-e'),'Cinch Timed Event Championship','cinch-tec-2026','rodeo','timed event','2026-04-10','2026-04-12','Cinch / Lazy E Arena',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='lazy-e'),'NRHA Futurity','nrha-futurity-2026','futurity','reining','2026-11-20','2026-12-05','NRHA','https://www.nrha.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='okc-state-fair'),'NRHA Derby','nrha-derby-2026','futurity','reining','2026-06-15','2026-06-28','NRHA','https://www.nrha.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='tulsa-expo'),'International Finals Rodeo','ifr-2026','rodeo','rodeo','2026-01-09','2026-01-17','IFR Committee',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='south-point'),'South Point Futurity','south-point-futurity-2026','futurity','reining','2026-05-01','2026-05-05','South Point Equestrian',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='south-point'),'World Series of Team Roping','wstr-finals-2026','roping','team roping','2026-12-04','2026-12-13','WSTR','https://www.wstr.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='reno-sparks-livestock'),'Reno Rodeo','reno-rodeo-2026','rodeo','rodeo','2026-06-18','2026-06-27','Reno Rodeo Association','https://www.renorodeo.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='will-rogers'),'NCHA Summer Spectacular','ncha-summer-2026','futurity','cutting','2026-06-10','2026-07-05','NCHA','https://www.nchacutting.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='will-rogers'),'Fort Worth Stock Show & Rodeo','fw-stock-show-2026','rodeo','rodeo','2026-01-16','2026-02-07','FWSSR','https://www.fwssr.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='nrg-center-houston'),'Houston Livestock Show & Rodeo','houston-rodeo-2026','rodeo','rodeo','2026-03-03','2026-03-22','HLSR','https://www.rodeohouston.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='star-of-texas'),'Rodeo Austin','rodeo-austin-2026','rodeo','rodeo','2026-03-13','2026-03-28','Rodeo Austin','https://www.rodeoaustin.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='great-southwest-equestrian'),'AQHA Gulf Coast Circuit Show','aqha-gulf-coast-2026','horse show','western','2026-05-15','2026-05-18','AQHA',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='mesquite-arena'),'Mesquite Championship Rodeo','mesquite-championship-2026','rodeo','rodeo','2026-06-06','2026-08-29','Mesquite Rodeo','https://www.mesquiterodeo.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='cheyenne-frontier-days'),'Cheyenne Frontier Days','cfd-2026','rodeo','rodeo','2026-07-17','2026-07-26','CFD Committee','https://www.cfdrodeo.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='national-western-complex'),'National Western Stock Show','nwss-2026','horse show','multi-discipline','2026-01-10','2026-01-26','NWSS','https://www.nationalwestern.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='colorado-horse-park'),'Colorado Horse Park Summer Series','chp-summer-2026','horse show','hunter jumper','2026-06-01','2026-08-15','CHP',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='kentucky-horse-park'),'Kentucky Three-Day Event','ky-three-day-2026','horse show','eventing','2026-04-23','2026-04-26','USEF','https://www.kyhorsepark.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='kentucky-horse-park'),'NRHA Derby at KHP','nrha-derby-khp-2026','futurity','reining','2026-09-14','2026-09-20','NRHA',NULL,'pending',FALSE),
((SELECT id FROM arenas WHERE slug='ky-exposition-center'),'All American Quarter Horse Congress','aaqhc-2026','horse show','western','2026-10-03','2026-10-25','AQHA','https://www.quarterhorsecongress.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='tryon-equestrian'),'Tryon Summer Series','tryon-summer-2026','horse show','hunter jumper','2026-06-10','2026-08-20','TIEC','https://www.tryon.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='tryon-equestrian'),'Tryon Fall Dressage','tryon-fall-dressage-2026','horse show','dressage','2026-09-25','2026-09-28','TIEC',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='pbiec'),'Winter Equestrian Festival','wef-2026','horse show','hunter jumper','2026-01-07','2026-03-29','Equestrian Sport Productions','https://www.pbiec.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='bob-thomas-equestrian'),'Tampa Bay Classic','tampa-bay-classic-2026','horse show','multi-discipline','2026-04-08','2026-04-12','FL Horse Shows Inc',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='florida-horse-park'),'Ocala Spring Dressage','ocala-spring-dressage-2026','horse show','dressage','2026-03-20','2026-03-22','FHP',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='georgia-horse-park'),'Georgia International Horse Trials','ga-horse-trials-2026','horse show','eventing','2026-05-08','2026-05-10','GIHP',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='georgia-national-fair'),'Georgia National Rodeo','ga-national-rodeo-2026','rodeo','rodeo','2026-10-08','2026-10-17','GNFA','https://www.gnfa.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='ohio-expo-center'),'All American Quarter Horse Congress','aqhc-columbus-2026','horse show','western','2026-10-01','2026-10-26','Ohio QHA','https://www.quarterhorsecongress.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='indiana-state-fair'),'Indiana State Fair','indiana-state-fair-2026','fair','multi-discipline','2026-07-31','2026-08-23','IN State Fair Commission','https://www.indianastatefair.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='iowa-state-fair'),'Iowa State Fair','iowa-state-fair-2026','fair','multi-discipline','2026-08-13','2026-08-23','Iowa State Fair Board','https://www.iowastatefair.org','approved',TRUE),
((SELECT id FROM arenas WHERE slug='american-royal'),'American Royal World Series of Barbecue','american-royal-bbq-2026','fair','agricultural','2026-09-18','2026-09-20','American Royal',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='illinois-state-fair'),'Illinois State Fair','illinois-state-fair-2026','fair','multi-discipline','2026-08-13','2026-08-23','IL Dept of Agriculture','https://www.statefair.illinois.gov','approved',TRUE),
((SELECT id FROM arenas WHERE slug='mn-state-fair'),'Minnesota State Fair','mn-state-fair-2026','fair','multi-discipline','2026-08-27','2026-09-07','MN State Fair Board','https://www.mnstatefair.org','approved',TRUE),
((SELECT id FROM arenas WHERE slug='metrapark'),'NILE Stock Show & Rodeo','nile-2026','rodeo','rodeo','2026-10-17','2026-10-24','NILE','https://www.thenile.org','approved',TRUE),
((SELECT id FROM arenas WHERE slug='central-states-fair'),'Central States Fair Rodeo','csf-rodeo-2026','rodeo','rodeo','2026-08-14','2026-08-22','CSF Board',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='del-mar-fairgrounds'),'Del Mar National Horse Show','del-mar-national-2026','horse show','hunter jumper','2026-04-28','2026-05-10','DMTC','https://www.delmarfairgrounds.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='hits-hudson'),'HITS Saugerties Summer Series','hits-saugerties-2026','horse show','hunter jumper','2026-06-03','2026-09-13','HITS','https://www.hitsshows.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='virginia-horse-center'),'Virginia Horse Festival','va-horse-festival-2026','expo','multi-discipline','2026-04-03','2026-04-05','VHC',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='lancaster-event-center'),'Lancaster Super Fair','lancaster-super-fair-2026','fair','agricultural','2026-08-06','2026-08-15','Lancaster Event Center',NULL,'approved',TRUE),
((SELECT id FROM arenas WHERE slug='cam-plex'),'National High School Finals Rodeo','nhsfr-2026','rodeo','rodeo','2026-07-19','2026-07-25','NHSRA','https://www.nhsra.com','approved',TRUE),
((SELECT id FROM arenas WHERE slug='westworld-scottsdale'),'Arizona Equifest','az-equifest-2026','expo','multi-discipline','2026-04-04','2026-04-06','Equifest Productions',NULL,'pending',FALSE)
;
...
(NULL,'Purina','purina','platinum','https://www.purinamills.com',TRUE),
(NULL,'Wrangler','wrangler','platinum','https://www.wrangler.com',TRUE),
(NULL,'AQHA','aqha','platinum','https://www.aqha.com',TRUE),
(NULL,'Cinch Jeans','cinch-jeans','gold','https://www.cinch.com',TRUE),
(NULL,'Platinum Performance','platinum-performance','gold','https://www.platinumperformance.com',TRUE),
(NULL,'Professional''s Choice','professionals-choice-sponsor','gold','https://www.profchoice.com',TRUE),
(NULL,'Classic Equine','classic-equine-sponsor','gold','https://www.classisequine.com',TRUE),
((SELECT id FROM arenas WHERE slug='westworld-scottsdale'),'Cactus Saddlery','cactus-saddlery','silver','https://www.cactussaddlery.com',TRUE),
((SELECT id FROM arenas WHERE slug='lazy-e'),'Resistol','resistol','silver','https://www.resistol.com',TRUE),
(NULL,'Nutrena','nutrena','silver','https://www.nutrenaworld.com',TRUE),
(NULL,'Martin Saddlery','martin-saddlery-sponsor','silver','https://www.martinsaddlery.com',TRUE),
(NULL,'Farnam','farnam-sponsor','silver','https://www.farnam.com',TRUE),
(NULL,'Smartpak','smartpak-sponsor','bronze','https://www.smartpak.com',TRUE),
(NULL,'Weatherbeeta','weatherbeeta-sponsor','bronze','https://www.weatherbeeta.com',TRUE),
(NULL,'Vettec','vettec-sponsor','bronze','https://www.vettec.com',TRUE),
(NULL,'Tribute Equine Nutrition','tribute-sponsor','bronze','https://www.tributeequinenutrition.com',TRUE)
;
...
(NULL,'Arena Network Platform Launches for 2026 Season','arena-network-launch-2026','The Arena Network, a new national directory and calendar platform for agricultural and equine centers, officially launches for the 2026 season. The platform connects 124 arenas across 38 states with event promoters, vendors, and sponsors in a single searchable hub designed for the western and agricultural event industry. Arena managers can claim their facilities, manage events, and connect with vendors through the dashboard.','2026-03-01',TRUE),
((SELECT id FROM arenas WHERE slug='westworld-scottsdale'),'WestWorld Announces 2026 Sun Circuit Dates','westworld-sun-circuit-dates-2026','WestWorld of Scottsdale has confirmed the 2026 Arizona Sun Circuit will run March 20 through March 29. The annual show draws thousands of competitors across multiple western disciplines and is one of the largest events on the WestWorld calendar. Entry information and stall reservations opened January 15. WestWorld has expanded RV parking capacity to 800 spaces for this year''s event.','2026-01-10',TRUE),
...
-- ════════════════════════════════════════════════════════════
DO $$ BEGIN
    RAISE NOTICE 'Arenas:  %', (SELECT COUNT(*) FROM arenas);
    RAISE NOTICE 'Events:  %', (SELECT COUNT(*) FROM events);
    RAISE NOTICE 'Vendors: %', (SELECT COUNT(*) FROM vendors);
    RAISE NOTICE 'Sponsors:%', (SELECT COUNT(*) FROM sponsors);
    RAISE NOTICE 'Users:   %', (SELECT COUNT(*) FROM users);
    RAISE NOTICE 'News:    %', (SELECT COUNT(*) FROM news);
END $$;
